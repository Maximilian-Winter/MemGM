...
class CoreMemoryKey(Enum):
    GGI: str = "General Game Information"
    PLAYERS: str = "Players"
    GAME_PROGRESS: str = "Game Progress"
...
class conversation_search_date(BaseModel):
    ...
    def run(self, event_memory_manager: EventMemoryManager):
        ...
        return event_memory_manager.query_events(event_types=[EventType.UserMessage, EventType.AgentMessage, EventType.SystemMessage, EventType.FunctionMessage],
                                                 start_date=parsed_start_datetime, end_date=parsed_end_datetime, page=self.page)
